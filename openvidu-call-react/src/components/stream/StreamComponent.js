            ...
            <div className="OT_widget-container">
                ...
                {this.props.user !== undefined && this.props.user.getStreamManager() !== undefined ? (
                    <div className="streamComponent">
                        ...
                        <div>
                        /*Descomentar las lineas de abajo para mostrar el botoon de cancelar volumen*/
                            ...
                            82 <div onClick={this.toggleNicknameForm}>
                            83 <span id="nickname">{this.props.user.getNickname()}</span>
                            84 {this.props.user.isLocal() && <span> (edit)</span>}
                            85 </div>
                        //EStas lineas son para poder editar el nickname de cada usuario
                        //sustituir de la linea 82 a la 85 para que funcione
                            */
                        </div>
                    </div>
                ) : null}
